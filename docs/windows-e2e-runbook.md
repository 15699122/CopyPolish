...
- `simplified-trad-conversion.spec.ts`：1/2。s2t case 通过；t2s case 读取到 `conversion: s2t` 而非 `conversion: t2s`，日志 `C:\Users\Shiraishi\AppData\Local\Temp\copypolish-feature-serial-20260903.log`，该项不能标记完成；
