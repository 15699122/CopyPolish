...
> 当前基线：`0.7.0-dev.1`，最后更新：2026-09-07。

## 0. 版本范围与功能冻结

v0.6.2 是隐私、安全、依赖和供应链维护版本。该版本不增加用户功能、不新增排版规则，也不改变现有规则默认行为。v0.6.2 已于 **2026-09-07** 正式发布，当前开发基线为 `0.7.0-dev.1`，v0.7.0 功能开发恢复。完整阶段计划和历史发布门槛见 [roadmap.md](roadmap.md)。
