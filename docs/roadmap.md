...
1. 先完成 `v0.5.0` Draft Release 的资产补齐、Release Notes 复核和 latest 发布，再处理正式发布后的持续开发；
2. 每项改动先补测试与文档，再改实现；
...
- [ ] 正式 Release 资产、Release Notes 与 latest 标记复核；当前 Draft 已有 4 个发布资产和 `SHA256SUMS`，缺少 AppImage，latest 仍为 `v0.4.0`；
