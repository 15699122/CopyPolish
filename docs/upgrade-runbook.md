...
v0.6.2 安全维护周期已结束，该版本已于 **2026-09-07** 正式发布，当前开发基线为 `0.7.0-dev.1`。常规升级可正常引入新用户功能与新排版规则，但仍需遵守本 Runbook 的审阅、验证和回滚要求。

发布操作必须按照 [release/manual-release.md](release/manual-release.md) 执行。
